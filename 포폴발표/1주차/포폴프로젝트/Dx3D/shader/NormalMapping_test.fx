...
VS_OUTPUT NormalMapping_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   ...
   Output.mDisVec.xyz = Input.mPosition.xyz - gWorldLightPosition.xzy;
...
float3 NormalMapping_Pass_0_Pixel_Shader_gWorldLightPosition;
float gRange
<
...
float4 NormalMapping_Pass_0_Pixel_Shader_ps_main(PS_INPUT Input) : COLOR 
{
   ...
   return float4((ambient + diffuse + specular)*Power, 1);
