...
private:
	...
	CRT_ANIMLIST						m_prevAnim;
	//bool										m_isInteract;						//상호작용 여부
	CRT_INTERACTION				m_enumInteraction;			//상호작용
	CRT_INTERACTION				m_enumPrevInteraction;		//이전 상호작용
	...
	bool										m_isNervous;
	float								m_dwAnimTime;
	float								m_fNervousTime;

private:
	void SetSound();						//필요 사운드 조정

	void SetWalkSound();				//발걸음 재생
	void SetNervousSound();			//심장박동 재생
